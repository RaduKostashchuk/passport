package ru.job4j.passport.firstservice.controller;

import org.springframework.http.HttpStatus;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;
import ru.job4j.passport.firstservice.model.Passport;
import ru.job4j.passport.firstservice.service.PassportService;
...
public class PassportControl {
    ...
    public PassportControl(PassportService service) {
    ...
    public ResponseEntity<Void> update(@RequestParam(value = "id") int id,
        ...
        passport.setId(id);
        return new ResponseEntity<>(service.update(passport) != null ? HttpStatus.OK : HttpStatus.NOT_FOUND);
    }
